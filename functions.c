...
int input(coordinates1 *f1, coordinates2 *f2, coordinates3 *f3) 
{
	...
	if ((strcmp (figure1, CorrectData1) != 0 && strcmp (figure1, CorrectData2) != 0 && strcmp (figure1, CorrectData3) != 0) || (strcmp (figure2, CorrectData1) != 0 && strcmp (figure2, CorrectData2) != 0 && strcmp (figure2, CorrectData3) != 0) || (strcmp (figure3, CorrectData1) != 0 && strcmp (figure3, CorrectData2) != 0 && strcmp (figure3, CorrectData3) != 0)) {
